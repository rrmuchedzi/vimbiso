...
public class SQL_ScheduledMedicationContract {

    public static final String TABLE_NAME = "Scheduled_Medication";
    ...
    static Uri buildTaskUri(long medicationScheduledID ) {
        return ContentUris.withAppendedId(CONTENT_URI, medicationScheduledID);
    }

    static long getMedicationScheduledID( Uri uri ) {
